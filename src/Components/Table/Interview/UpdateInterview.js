...
import {
  convertDateLocal,
  convertDateLocalHour,
} from "../../../utils/common/convertDate";
  ...
  async getInterviewDetail() {
    ...
    if (response) {
      ...
      if (data.jobSelected) {
        ...
        const fillDataSelectedCandidate = _.find(
          this.state.candidates,
          (candidate) => candidate.value === interview.CandidateJob.Candidate.id
        );
  ...
  async handleUpdateInterview(e) {
    ...
    if (this.isEmpty(errors)) {
      const item = {
        ...
        timeInterviewEnd: `${data.timeInterview
          .format("MM/DD/YYYY HH:mm")
          .substring(0, 11)}${data.timeInterviewEnd.format("HH:mm")}`,
      ...
      try {
        const response = await api.patch(
          `/api/admin/interview/${this.props.id}`,
          item
        );
        if (response) {
        ...
        toast(
          <CustomToast title={"Update error some times!"} type={"error"} />,
          {
            position: toast.POSITION.TOP_CENTER,
            autoClose: 3000,
            className: "toast_login",
              ...
              <div className="card card-custom">
                <div className="card-header flex-wrap border-0 pt-6 pb-0">
                  <div className="card-title">
                    <h3 className="card-label">Update Interview</h3>
                  </div>
                    ...
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        ...
                        <Select
                          ...
                          className={
                            errors.candidateId ? "invalid-selected" : ""
                          }
                          ...
                          <div className="row">
                            <div className="col-md-12">
                              ...
                              <span className="form-text text-muted">
                                Password zoom need have a maximum of 10
                                characters.
                              </span>
                            </div>
                          </div>
                            ...
                            >
                              <div className="custom-date-picker-interview__wrap">
                                <input
                                  readOnly
                                  name="timeInterview"
                                  value={convertDateLocal(
                                    this.state.timeInterview
                                  )}
                                  className={"form-control"}
