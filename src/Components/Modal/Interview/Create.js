  ...
  handleCreateInterview(e) {
    ...
    if (this.isEmpty(errors)) {
      const item = {
        ...
        jobId: data.jobId,
        timeInterview: dynamicDateServer(data.timeInterview).format(
          "MM/DD/YYYY HH:mm"
        ),
        timeInterviewEnd: `${dynamicDateServer(data.timeInterview)
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        ...
                        <span className="form-text text-muted">
                          Password zoom need have a maximum of 10 characters.
                        </span>
                      </div>
                    </div>
                  </div>
                      ...
                      >
                        <div className="custom-date-picker-interview__wrap">
                          <input
                            readOnly
                            name="timeInterview"
                            value={this.state.timeInterview.format(
                              "YYYY-MM-DD HH:mm"
                            )}
                            className={"form-control"}
