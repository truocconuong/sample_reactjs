...
export function getCustomCss({ appearance = 'default', spacing = 'default', mode = 'light', isSelected = false, shouldFitContainer = false, iconIsOnlyChild = false, isLoading = false, state, }) {
    let result = getCss({
        appearance,
        spacing,
        mode,
