...
declare const Theme: {
    Consumer: import("react").ComponentType<Partial<import("./custom-theme-button-types").CustomThemeButtonProps> & {
        state: "default" | "disabled" | "selected" | "hover" | "active" | "focus" | "focusSelected";
