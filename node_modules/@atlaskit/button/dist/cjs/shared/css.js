...
exports.overlayCss = exports.getFadingCss = exports.getContentStyle = exports.getIconStyle = exports.getCss = void 0;
var tslib_1 = require("tslib");
var constants_1 = require("@atlaskit/theme/constants");
var colors_1 = tslib_1.__importDefault(require("./colors"));
var borderRadius = constants_1.borderRadius();
var gridSize = constants_1.gridSize();
var fontSize = constants_1.fontSize();
// ## Button layout
//
// /------------------------------------------------------------------------------------------------------------------\
// |       →  |  ←      |          |      →  |  ←      |           |      →  |  ←      |         |      →  |  ←       |
...
function getCss(_a) {
    ...
    return tslib_1.__assign(tslib_1.__assign({ alignItems: 'baseline', borderWidth: 0, borderRadius: borderRadius, boxSizing: 'border-box', display: 'inline-flex', fontSize: 'inherit', fontStyle: 'normal', 
        ...
        '&:visited': tslib_1.__assign({}, baseColors), '&:hover': tslib_1.__assign(tslib_1.__assign({}, getColors({
            appearance: appearance,
            ...
            transitionDuration: '0s, 0.15s' }), '&:focus': tslib_1.__assign(tslib_1.__assign({}, getColors({
            appearance: appearance,
            key: isSelected ? 'focusSelected' : 'focus',
            mode: mode,
        })), { boxShadow: "0 0 0 2px " + colors_1.default.boxShadowColor[appearance].focus[mode], 
            // background, box-shadow
            transitionDuration: '0s, 0.2s', 
            // disabling browser focus outline
            outline: 'none' }), 
        // giving active styles preference by listing them after focus
        '&:active': tslib_1.__assign(tslib_1.__assign({}, getColors({
            appearance: appearance,
        ...
        '&[data-firefox-is-active="true"]': tslib_1.__assign(tslib_1.__assign({}, getColors({
            appearance: appearance,
            key: isSelected ? 'selected' : 'active',
            mode: mode,
        })), { 
        ...
        '&[disabled]': tslib_1.__assign(tslib_1.__assign({}, getColors({ appearance: appearance, key: 'disabled', mode: mode })), { cursor: 'not-allowed', textDecoration: 'none' }), '&[data-has-overlay="true"]': {
            cursor: 'default',
            textDecoration: 'none',
        }, 
        // disabling hover and active color changes when there is an overlay, but the button is not disabled
        '&[data-has-overlay="true"]:not([disabled]):hover, &[data-has-overlay="true"]:not([disabled]):active': tslib_1.__assign({}, getColors({
            appearance: appearance,
            key: isSelected ? 'selected' : 'default',
            mode: mode,
        })), '&::-moz-focus-inner': {
