...
var react_scrolllock_1 = tslib_1.__importStar(require("react-scrolllock"));
    ...
    Content.prototype.render = function () {
        ...
        return (core_1.jsx(Container, { css: Content_1.wrapperStyles, "data-testid": testId },
            isChromeless ? (children) : (core_1.jsx(react_1.default.Fragment, null,
                core_1.jsx(Header_1.default, { id: headingId, appearance: appearance, component: components.Header ? components.Header : header, heading: heading, onClose: onClose, isHeadingMultiline: isHeadingMultiline, showKeyline: showHeaderKeyline, testId: testId }),
                this.scrollContainer instanceof HTMLElement ? (core_1.jsx(react_scrolllock_1.TouchScrollable, null, function (touchRef) { return (core_1.jsx(Body, tslib_1.__assign({ tabIndex: showContentFocus ? 0 : undefined, css: Content_1.bodyStyles(shouldScroll) }, (!Body.hasOwnProperty('styledComponentId')
                    ? {
                    ...
                    })), children)); })) : (core_1.jsx(Body, tslib_1.__assign({ tabIndex: showContentFocus ? 0 : undefined, css: Content_1.bodyStyles(shouldScroll) }, (!Body.hasOwnProperty('styledComponentId')
                    ? {
