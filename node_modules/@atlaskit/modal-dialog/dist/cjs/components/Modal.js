...
exports.ModalDialogWithoutAnalytics = void 0;
        ...
        return (react_1.default.createElement(Animation_1.Animation, { in: isOpen, onExited: onCloseComplete, onEntered: onOpenComplete, stackIndex: stackIndex }, function (_a) {
            ...
            return (react_1.default.createElement(Modal_1.FillScreen, { style: fade, "aria-hidden": isBackground, scrollDistance: scrollDistance },
                react_1.default.createElement(FocusLock_1.default, { isEnabled: stackIndex === 0 && isOpen, autoFocus: autoFocus },
                    react_1.default.createElement(blanket_1.default, { isTinted: !isBlanketHidden, onBlanketClicked: _this.handleOverlayClick }),
                    react_1.default.createElement(Positioner_1.default, { style: slide, scrollBehavior: scrollBehavior, widthName: widthName, widthValue: widthValue },
                        react_1.default.createElement(react_uid_1.UIDReset, null,
                            react_1.default.createElement(react_uid_1.UIDConsumer, null, function (id, _) { return (react_1.default.createElement(Modal_1.Dialog, { heightValue: height, isChromeless: isChromeless, role: "dialog", "aria-labelledby": "dialog-heading-" + id, "data-testid": testId, tabIndex: -1 },
                                react_1.default.createElement(Content_1.default, { actions: actions, appearance: appearance, components: components, footer: footer, heading: heading, headingId: "dialog-heading-" + id, testId: testId && testId + "-dialog-content", isHeadingMultiline: isHeadingMultiline, header: header, onClose: onClose, shouldScroll: scrollBehavior === 'inside' ||
